  ...
  return (
    <nav>
      ...
      <ul className="navbar">
        <li>
          <a href="#">
            <img src={macelogo} alt="logo" />
          </a>
        </li>
        <div className="seprow">
          <li>
            <a
              className={`hideOnMobile ${activeSection === "home" ? "active" : ""
                }`}
              href="#"
              onClick={() => handleLinkClick("home")}
            >
          ...
          <li>
            <a
              className={`hideOnMobile ${activeSection === "about" ? "active" : ""
                }`}
              href="#about"
              onClick={() => handleLinkClick("about")}
            >
          ...
          <li>
            <a
              className={`hideOnMobile ${activeSection === "timeline" ? "active" : ""
                }`}
              href="#timeline"
              onClick={() => handleLinkClick("timeline")}
            >
          ...
          <li>
            <a
              className={`hideOnMobile ${activeSection === "sessions" ? "active" : ""
                }`}
              href="#sessions"
              onClick={() => handleLinkClick("sessions")}
            >
          ...
          <li>
            <a
              className={`hideOnMobile ${activeSection === "sponsors" ? "active" : ""
                }`}
              href="#sponsors"
              onClick={() => handleLinkClick("sponsors")}
            >
        ...
        <li
          className="menu-btn hideOnMobile"
